    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CustomerEmail = c.String(nullable: false, maxLength: 256, unicode: false),
                        CustomerMobile = c.String(nullable: false, maxLength: 50, unicode: false),
                        CustomerMesage = c.String(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ProductTags = c.Int(nullable: false),
                        TagID = c.String(nullable: false, maxLength: 50, unicode: false),
                    })
                .PrimaryKey(t => new { t.ProductTags, t.TagID })
                .ForeignKey("dbo.Products", t => t.ProductTags, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.TagID, cascadeDelete: true)
                .Index(t => t.ProductTags)
                .Index(t => t.TagID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ProductTags", "ProductTags", "dbo.Products");
            ...
            DropIndex("dbo.ProductTags", new[] { "ProductTags" });
